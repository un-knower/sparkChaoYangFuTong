...
//
//
//import com.ald.stat.component.dimension.trend.{HourDimensionKey, HourSessionSubDimensionKey, HourUidSubDimensionKey}
...
//
//object SessionStatTest extends App {
//
//  val baseRedisKey = "rt:";
...
//    logRecordRdd.cache();
//
//    val result = SessionStatImpl.stat(logRecordRdd, HourSessionSubDimensionKey, SessionBaseImpl)
//    //session处理
//    val sessionRDD = SessionStatImpl.doCache(baseRedisKey, taskId, dateStr, result, HourSessionSubDimensionKey)
//    //uv
//    val uvRDD = UVStat.statIncreaseCache(baseRedisKey, dateStr, HourUidSubDimensionKey, logRecordRdd)
//    //open count
//    val opRDD = UVStat.statIncreaseCache(baseRedisKey, dateStr, HourSessionSubDimensionKey, logRecordRdd)
//    //pv
//    val pvRDD = PVStat.statIncreaseCache(baseRedisKey, dateStr, taskId, HourDimensionKey, logRecordRdd)
//
//    //最终结果集
