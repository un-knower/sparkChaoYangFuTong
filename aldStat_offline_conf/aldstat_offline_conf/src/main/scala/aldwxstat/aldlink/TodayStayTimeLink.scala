  ...
  def insert2db(): Unit = {
    ...
    linkDailyDetail.na.fill("0").na.fill(0).foreachPartition(rows => {
      ...
      rows.foreach(row => {
        ...
        val total_stay_time = row.get(1)
        val secondary_avg_stay_time = row.get(2)
...
class TodayLinkStayTime(spark: SparkSession) {
  ...
  def insert2db(): Unit = {
    ...
    linkDailyDetail.na.fill("0").na.fill(0).foreachPartition(rows => {
      ...
      rows.foreach(row => {
        val app_key = row.get(0)
        val ag_ald_link_key = row.get(1)
        val total_stay_time = row.get(2)
        val secondary_avg_stay_time = row.get(3)
...
class TodayPositionStayTime(spark: SparkSession) {
  ...
  def insert2db(): Unit = {
    ...
    linkDailyDetail.na.fill("0").na.fill(0).foreachPartition(rows => {
      ...
      rows.foreach(row => {
        val app_key = row.get(0)
        val ag_ald_position_id = row.get(1)
        val total_stay_time = row.get(2)
        val secondary_avg_stay_time = row.get(3)
  ...
  def insert2db(): Unit = {
    ...
    linkDailyDetail.na.fill("0").na.fill(0).foreachPartition(rows => {
      ...
      rows.foreach(row => {
        val app_key = row.get(0)
        val hour = row.get(1)
        val ag_ald_link_key = row.get(2)
        val total_stay_time = row.get(3)
        val secondary_avg_stay_time = row.get(4)
  ...
  def insert2db(): Unit = {
    ...
    linkDailyDetail.na.fill("0").na.fill(0).foreachPartition(rows => {
      ...
      rows.foreach(row => {
        val app_key = row.get(0)
        val hour = row.get(1)
        val ag_ald_position_id = row.get(2)
        val total_stay_time = row.get(3)
        val secondary_avg_stay_time = row.get(4)
