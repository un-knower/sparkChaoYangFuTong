...
object AldTerminalDetails {
  def main(args: Array[String]): Unit = {
    ...
    spark.sql("select ak,uu,at,wvv, nt, lang, wv, sv, wsdk, ww,wh,ifo,dr,ev from logs where ev='app'")
    ...
    spark.sql("select ak,uu,wvv, nt, lang, wv, sv, wsdk, ww,wh,pp,at,dr from logs where ev='page'")
